...
/// <c>DroneControls.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1003)]
public interface DroneControlsWriter : DroneControlsReader
{
  DroneControls.Updater Update { get; }
}

/// <summary>
/// Deprecated and will be removed in a future version. Consider migrating to the simplified
/// <c>DroneControls.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1003)]
public interface DroneControlsReader
{
  bool IsAuthoritativeHere { get; }
  event global::System.Action PropertyUpdated;
  event global::System.Action<bool> AuthorityChanged;
  // Field force = 1.
  global::Improbable.Math.Vector3f Force { get; }
  event global::System.Action<global::Improbable.Math.Vector3f> ForceUpdated;
}

public partial class DroneControls : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1003)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>DroneControlsWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Player.DroneControlsData Data { get; }

    /// <summary>
    /// Triggered whenever an update is received for this component.
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>DroneControlsReader</c> interface, registered handlers are not
  ...
  public interface Updater
  {
    void FinishAndSend();
    // Field force = 1.
    Updater Force(global::Improbable.Math.Vector3f newValue);
  }
  ...
  {
    dispatcher.OnAddComponent<DroneControls>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component DroneControls added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<DroneControls>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component DroneControls removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<DroneControls>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<DroneControls>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  public class Impl : DroneControlsWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public global::Improbable.Player.DroneControlsData Data
    {
    ...
    private DroneControls.Update currentUpdate = null;
    ...
    public Updater Update
    {
      get
      {
        ...
        {
          currentUpdate = new DroneControls.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component DroneControls called with an update already in-flight! " +
    ...
    public void FinishAndSend()
    {
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "FinishAndSend() for component DroneControls called with no update in-flight!"));
      }
    }
    ...
    event global::System.Action<bool> DroneControlsReader.AuthorityChanged
    {
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Math.Vector3f>> forceWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Math.Vector3f>>(ForceUpdated_Wrap);

    private static global::System.Action<Update> ForceUpdated_Wrap(global::System.Action<global::Improbable.Math.Vector3f> action)
    {
      return (update) => { if (update.force.HasValue) { action(update.force.Value); } };
    }

    public event global::System.Action<global::Improbable.Math.Vector3f> ForceUpdated
    {
      add { ComponentUpdated += forceWrapper.Add(value, value.Target); value(Data.force); }
      remove { ComponentUpdated -= forceWrapper.Remove(value, value.Target); }
    }

    Updater Updater.Force(global::Improbable.Math.Vector3f newValue)
    {
      currentUpdate.SetForce(newValue);
      return this;
    }
    ...
    private bool FinishAndSend_ResolveDiff(Update update)
    {
      ...
      {
        if (update.force.Value == Data.force)
        {
          update.force.Clear();
        }
        else
    ...
    {
      forceWrapper.DisconnectTarget(actionTarget);
    }
