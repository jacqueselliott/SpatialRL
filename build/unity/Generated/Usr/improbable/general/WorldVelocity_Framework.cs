...
/// <c>WorldVelocity.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1004)]
public interface WorldVelocityWriter : WorldVelocityReader
{
  WorldVelocity.Updater Update { get; }
}

/// <summary>
/// Deprecated and will be removed in a future version. Consider migrating to the simplified
/// <c>WorldVelocity.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1004)]
public interface WorldVelocityReader
{
  bool IsAuthoritativeHere { get; }
  event global::System.Action PropertyUpdated;
  event global::System.Action<bool> AuthorityChanged;
  // Field velocity = 1.
  global::Improbable.Math.Vector3f Velocity { get; }
  event global::System.Action<global::Improbable.Math.Vector3f> VelocityUpdated;
}

public partial class WorldVelocity : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1004)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>WorldVelocityWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.General.WorldVelocityData Data { get; }

    /// <summary>
    /// Triggered whenever an update is received for this component.
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>WorldVelocityReader</c> interface, registered handlers are not
  ...
  public interface Updater
  {
    void FinishAndSend();
    // Field velocity = 1.
    Updater Velocity(global::Improbable.Math.Vector3f newValue);
  }
  ...
  {
    dispatcher.OnAddComponent<WorldVelocity>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component WorldVelocity added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<WorldVelocity>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component WorldVelocity removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<WorldVelocity>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<WorldVelocity>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  public class Impl : WorldVelocityWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public global::Improbable.General.WorldVelocityData Data
    {
    ...
    private WorldVelocity.Update currentUpdate = null;
    ...
    public Updater Update
    {
      get
      {
        ...
        {
          currentUpdate = new WorldVelocity.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component WorldVelocity called with an update already in-flight! " +
    ...
    public void FinishAndSend()
    {
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "FinishAndSend() for component WorldVelocity called with no update in-flight!"));
      }
    }
    ...
    event global::System.Action<bool> WorldVelocityReader.AuthorityChanged
    {
    ...
    private readonly global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Math.Vector3f>> velocityWrapper =
        new global::Improbable.Entity.Component.DeprecatedEvent<global::System.Action<Update>, global::System.Action<global::Improbable.Math.Vector3f>>(VelocityUpdated_Wrap);

    private static global::System.Action<Update> VelocityUpdated_Wrap(global::System.Action<global::Improbable.Math.Vector3f> action)
    {
      return (update) => { if (update.velocity.HasValue) { action(update.velocity.Value); } };
    }

    public event global::System.Action<global::Improbable.Math.Vector3f> VelocityUpdated
    {
      add { ComponentUpdated += velocityWrapper.Add(value, value.Target); value(Data.velocity); }
      remove { ComponentUpdated -= velocityWrapper.Remove(value, value.Target); }
    }

    Updater Updater.Velocity(global::Improbable.Math.Vector3f newValue)
    {
      currentUpdate.SetVelocity(newValue);
      return this;
    }
    ...
    private bool FinishAndSend_ResolveDiff(Update update)
    {
      ...
      {
        if (update.velocity.Value == Data.velocity)
        {
    ...
    {
      velocityWrapper.DisconnectTarget(actionTarget);
    }
