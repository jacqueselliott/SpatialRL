...
#ifndef IMPROBABLE_WORKER_SDK_INCLUDE_IMPROBABLE_DEFAULTS_H
#define IMPROBABLE_WORKER_SDK_INCLUDE_IMPROBABLE_DEFAULTS_H
#include <cstddef>
#include <cstdint>
#include <string>
...
#endif  // IMPROBABLE_WORKER_SDK_INCLUDE_IMPROBABLE_DEFAULTS_H
